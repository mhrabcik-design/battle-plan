...
Adding stable `subject_id`, `occurrence_key`, and `source_refs` to proposals plus explicit terminal/comment/defer responses changed the exact artifact hash from `sha256:fa0496524c56796ff8eec77f5ccd013b4b6d404836d673b1cb8dcc70ae96d7d7` to `sha256:bc3929e40fb2c4bc26a4f32fd917232d279778edd117576ad3fba4d6d3a281f2`. This is an intentional compatibility boundary while v2 remains pre-cutover. A peer advertising an older tuple is not contract-compatible even though both envelopes say `2.0.0`; pairing/capability stays disabled until both advertise the new exact tuple.
