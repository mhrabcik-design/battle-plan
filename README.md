...
- Verze aplikace: `4.2.1` podle `battle-plan/package.json`.
...
Pro dalsi praci s Compound Engineering pluginy zacni v `docs/README.md`. Aktualni implementacni zaklad je `main` na verzi `4.2.1`; historicke `docs/PLAN-*` dokumenty pouzivej jen jako kontext. Pri produkcnim deployi vzdy zkontroluj, ze verze v `battle-plan/package.json`, viditelna verze v UI a nasazeny bundle na `gh-pages` patri ke stejne zmene.
